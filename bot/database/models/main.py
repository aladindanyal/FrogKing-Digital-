...
class StoreSettings(Database.BASE):
    ...
    shop_root_title_ru = Column(String(255), nullable=True)
    shop_root_title_zh = Column(String(255), nullable=True)
    shop_root_title_vi = Column(String(255), nullable=True)
    shop_root_title_tr = Column(String(255), nullable=True)
    shop_root_title_es = Column(String(255), nullable=True)

    shop_root_description_en = Column(Text, nullable=True)
    shop_root_description_ar = Column(Text, nullable=True)
    shop_root_description_ru = Column(Text, nullable=True)
    shop_root_description_zh = Column(Text, nullable=True)
    shop_root_description_vi = Column(Text, nullable=True)
    shop_root_description_tr = Column(Text, nullable=True)
    shop_root_description_es = Column(Text, nullable=True)

    main_menu_title_en = Column(String(255), nullable=True)
    main_menu_title_ar = Column(String(255), nullable=True)
    main_menu_title_ru = Column(String(255), nullable=True)
    main_menu_title_zh = Column(String(255), nullable=True)
    main_menu_title_vi = Column(String(255), nullable=True)
    main_menu_title_tr = Column(String(255), nullable=True)
    main_menu_title_es = Column(String(255), nullable=True)

    main_menu_description_en = Column(Text, nullable=True)
    main_menu_description_ar = Column(Text, nullable=True)
    main_menu_description_ru = Column(Text, nullable=True)
    main_menu_description_zh = Column(Text, nullable=True)
    main_menu_description_vi = Column(Text, nullable=True)
    main_menu_description_tr = Column(Text, nullable=True)
    main_menu_description_es = Column(Text, nullable=True)

    main_menu_footer_en = Column(String(255), nullable=True)
    main_menu_footer_ar = Column(String(255), nullable=True)
    main_menu_footer_ru = Column(String(255), nullable=True)
    main_menu_footer_zh = Column(String(255), nullable=True)
    main_menu_footer_vi = Column(String(255), nullable=True)
    main_menu_footer_tr = Column(String(255), nullable=True)
    main_menu_footer_es = Column(String(255), nullable=True)
...
class MainMenuButtonSettings(Database.BASE):
    ...
    label_ru = Column(String(255), nullable=True)
    label_zh = Column(String(255), nullable=True)
    label_vi = Column(String(255), nullable=True)
    label_tr = Column(String(255), nullable=True)
    label_es = Column(String(255), nullable=True)
...
class Categories(Database.BASE):
    ...
    name_tr = Column(String(100), nullable=True)
