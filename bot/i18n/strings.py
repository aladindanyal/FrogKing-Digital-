...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "orders.view_delivered": "🔑 View Delivered Items",
        "orders.copy_id": "📋 Copy Order ID",
        "orders.support": "🆘 Support for This Order",
        ...
        # === Admin Buttons (user management shortcuts) ===
        "transaction_error": "We couldn’t complete your order. No balance was deducted. Please try again.",
        ...
        # === Manual Fulfillment ===
        "intake.temporarily_unavailable": "❌ This product is temporarily unavailable for purchase (intake disabled).",
        "intake.draft_invalidated": "❌ Your draft has expired or product settings have changed. Please start again.",
        "intake.btn.resume_draft": "📝 Resume Draft",
        "intake.btn.cancel_draft": "❌ Cancel Draft",
        "intake.resume_title": "Unfinished Order",
        "intake.resume_body": "You have an unfinished order for {product_name}.",
        "intake.btn.resume": "Resume Order",
        "intake.btn.start_over": "Start Over",
        "intake.btn.cancel": "Cancel Order",
        "intake.error.expired": "Your saved order information has expired. A new form will be started.",
        "intake.error.mismatched": "The required product information has changed. A new form will be started.",
        "intake.intro_title": "📝 Order Intake",
        "intake.step_progress": "Question {current} of {total}",
        "intake.send_answer": "Please send your answer as a text message.",
        "intake.invalid_answer": "❌ Invalid answer format: {error}",
        "intake.secret_warning": "⚠️ For your security, this message will be deleted after being saved.",
        "intake.secret_delete_failed": "⚠️ Warning: We couldn't automatically delete your message containing sensitive data. Please delete it yourself for your security.",
        "intake.btn.skip": "⏭ Skip",
        "intake.review.title": "📝 Review Before Purchase",
        "intake.review.instructions": "Please review your details. If everything is correct, click \"Confirm and Pay\".",
        "intake.review.item": "• {label}: {value}",
        "intake.btn.confirm_pay": "✅ Confirm and Pay",
        "intake.payment_success": "✅ Details saved, your order is now processing!",
        "intake.already_purchased": "✅ This order has already been placed.",
        "intake.active_order.title": "⚠️ Existing Order",
        "intake.active_order.body": "You already have an order being processed for this product.\n\nOrder:\n{order_id}\n\nStatus:\nProcessing",
        "intake.btn.view_order": "View Existing Order",
        "intake.btn.buy_another": "Buy Another",
        "intake.processing_details": "Your order has been received and is now being prepared.\nYou will be notified when it is ready.",
        "intake.success.title": "Order Received",
        "intake.review.order_id": "Order ID",
        "intake.review.payment": "Payment",
        "intake.payment.confirmed": "Confirmed",
        "intake.review.status": "Status",
        "status.processing": "Processing",
        "intake.review.product": "Product",
        "intake.review.quantity": "Quantity",
        "intake.review.total": "Total",
        "intake.review.eta": "Estimated Delivery",
    ...
    "ar": {
        ...
        "intake.resume_title": "طلب غير مكتمل",
        "intake.resume_body": "لديك طلب غير مكتمل لمنتج {product_name}.",
        "intake.btn.resume": "متابعة الطلب",
        "intake.btn.start_over": "البدء من جديد",
        "intake.btn.cancel": "إلغاء الطلب",
        "intake.error.expired": "انتهت صلاحية بيانات الطلب المحفوظة، وسيتم بدء نموذج جديد.",
        "intake.error.mismatched": "تم تحديث المعلومات المطلوبة لهذا المنتج، وسيتم بدء نموذج جديد.",
        "intake.intro_title": "📝 تفاصيل الطلب",
        "intake.step_progress": "السؤال {current} من {total}",
        "intake.send_answer": "يرجى إرسال إجابتك كرسالة نصية.",
        "intake.invalid_answer": "❌ تنسيق الإجابة غير صالح: {error}",
        "intake.secret_warning": "⚠️ من أجل أمانك، سيتم حذف هذه الرسالة بعد حفظها.",
        "intake.secret_delete_failed": "⚠️ تحذير: لم نتمكن من حذف رسالتك التي تحتوي على بيانات حساسة تلقائيًا. يرجى حذفها بنفسك من أجل أمانك.",
        "intake.btn.skip": "⏭ تخطي",
        "intake.review.title": "📝 مراجعة قبل الدفع",
        "intake.review.instructions": "يرجى مراجعة تفاصيلك. إذا كان كل شيء صحيحًا، انقر فوق \"تأكيد ودفع\".",
        "intake.review.item": "• {label}: {value}",
        "intake.active_order.title": "⚠️ طلب حالي",
        "intake.active_order.body": "لديك بالفعل طلب قيد المعالجة لهذا المنتج.\n\nالطلب:\n{order_id}\n\nالحالة:\nقيد المعالجة",
        "intake.btn.view_order": "عرض الطلب الحالي",
        "intake.btn.buy_another": "شراء آخر",
        "intake.processing_details": "تم استلام طلبك ويتم تجهيزه الآن.\nسيتم إشعارك عندما يكون جاهزاً.",
        "intake.success.title": "تم استلام الطلب",
        "intake.review.order_id": "رقم الطلب",
        "intake.review.payment": "الدفع",
        "intake.payment.confirmed": "مؤكد",
        "intake.review.status": "الحالة",
        "status.processing": "قيد المعالجة",
        "intake.review.product": "المنتج",
        "intake.review.quantity": "الكمية",
        "intake.review.total": "الإجمالي",
        "intake.review.eta": "التسليم المقدر",
        "btn.to_menu": "🏠 الرئيسية",
        "intake.btn.confirm_pay": "✅ تأكيد ودفع",
        "intake.payment_success": "✅ تم حفظ التفاصيل، طلبك الآن قيد المعالجة!",
        "intake.already_purchased": "✅ تم تقديم هذا الطلب بالفعل.",
        # === Orders & Profile ===
        "btn.purchased": "🎁 طلباتي",
        "btn.wallet_history": "💳 سجل المحفظة",
        "orders.my_orders": "📦 طلباتي",
        "orders.previous_purchases": "🗂 المشتريات السابقة",
        "orders.empty": "📦 ليس لديك أي طلبات حتى الآن.",
        "orders.not_found": "الطلب غير موجود.",
        "orders.view_delivered": "🔑 عرض العناصر المستلمة",
        "orders.copy_id": "📋 نسخ رقم الطلب",
        "orders.support": "🆘 الدعم لهذا الطلب",
